...
describe('E2E tests', async function () {
    ...
    before(async () => { browser = await chromium.launch({ headless: true, slowMo: 500}); }); //{ headless: false, slowMo: 500}
    ...
    it('has working More button', async () => {
        ...
        expect(text).to.contain('Scalable Vector Graphics (SVG) is an');
    })
