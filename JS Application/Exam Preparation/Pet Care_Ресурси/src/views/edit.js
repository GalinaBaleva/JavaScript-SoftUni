...
import { createSubmitHandler } from "../util.js";
 ...
 //.value The dot is very important, that is a convention of lit-html
const editTmplate = (pet, onEdit) => html`        
<section id="editPage">
...
export async function showEdit(ctx){
    ...
    ctx.render(editTmplate(pet, createSubmitHandler(onEdit)));
